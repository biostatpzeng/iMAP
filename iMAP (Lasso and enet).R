iMAP=function(
	...
	alphax,
	LSA=FALSE# if TRUE, perform Lasso (alphax = 1) or Elastic Net (0< alphax < 1) for annotation selection;
...
if (LSA==TRUE) fitmlogit=Lassomlogit(x0,propx,fitmlogit$coef,fitmlogit$Var,alphax)
